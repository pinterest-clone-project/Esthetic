...
const stats = [
    { label: "Користувачі", value: "1,248", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" },
    { label: "Аури", value: "856", icon: "M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" },
    { label: "Теги", value: "42", icon: "M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-5 5a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 10V5a2 2 0 012-2z" },
    { label: "Категорії", value: "12", icon: "M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" },
];
...
const lineChartData = {
    ...
    datasets: [{
        data: [120, 150, 180, 170, 210, 250, 290],
        borderColor: '#6366f1',
...
const barChartData = {
    labels: ['Кат. 1', 'Кат. 2', 'Кат. 3', 'Кат. 4', 'Кат. 5'],
    datasets: [{
        data: [45, 80, 35, 110, 65],
        ...
        <SkeletonTheme baseColor="#202020" highlightColor="#333333">
            <div className="relative z-10 w-full max-w-full overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    <div className="bg-[#1a1a1a] border border-white/8 rounded-2xl p-4 sm:p-6 h-[280px] sm:h-[320px] flex flex-col">
                        <h3 className="text-white/80 text-sm font-medium tracking-[-0.2px] mb-4">Створені Аури (за категоріями)</h3>
                        <div className="relative flex-1 w-full min-h-0">
                            {isLoading ? (
                                <Skeleton height="100%" borderRadius={8} />
                            ) : (
