                ...
                <section className="mt-[40px] flex justify-center md:h-[475px] lg:h-[475px]">
                    ...
                    <div className="flex md:hidden gap-2 w-full px-4">
                        <img src={im1} className="w-0 flex-1 object-cover rounded-[12px]" style={{height: "48vw"}}
                             alt=""/>
                        <img src={im2} className="w-0 flex-1 object-cover rounded-[12px] self-start"
                             style={{height: "54vw"}} alt=""/>
                ...
                <div className={"grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-0 text-white w-full"}>
                    ...
                    <div className="flex lg:hidden gap-2 w-full px-4">
                        <img src={im6} className="w-0 flex-1 object-cover rounded-[12px]" style={{height: "48vw"}}
                             alt=""/>
                        <img src={im7} className="w-0 flex-1 object-cover rounded-[12px] self-start"
                             style={{height: "54vw"}} alt=""/>
                    ...
                    <section className="hidden lg:flex justify-center">
                        <div className="relative w-full max-w-[700px] h-[500px]">
                            ...
                            <img src={im6}
                                 className="absolute top-[4%] left-[23%] w-[150px] h-[150px] object-cover rounded-[15px]"
                                 alt=""/>
                            <img src={im7}
                                 className="absolute left-[55%] w-[300px] h-[300px] object-cover rounded-[15px]"
                                 alt=""/>
                            <img src={im8}
                                 className="absolute top-[55%] left-[65%] w-[200px] h-[200px] object-cover rounded-[15px]"
                                 alt=""/>
                            <img src={im5}
                                 className="absolute top-18 left-[40%] w-[300px] h-[400px] object-cover rounded-[15px]"
                                 alt=""/>
                        </div>
                    </section>
