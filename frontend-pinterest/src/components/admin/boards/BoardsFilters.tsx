...
const BoardsFilters = ({ search, onSearchChange, sortValue, onSortChange, pageSize, onPageSizeChange }: BoardsFiltersProps) => {
    ...
    return (
        <div className="flex flex-col sm:flex-row flex-wrap gap-3 mb-5">
            <input
                ...
                className="w-full sm:w-80 bg-gray-100 dark:bg-[#1a1a1a] border border-gray-200 dark:border-white/8 rounded-2xl px-4 py-2.5 text-sm text-gray-800 dark:text-white/80 outline-none focus:border-btn-primary/50 transition-colors placeholder:text-gray-400 dark:placeholder:text-white/30"
            />
            <SortSelect value={sortValue} options={BOARD_SORT_OPTIONS} onChange={onSortChange} />
