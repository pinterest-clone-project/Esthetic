...
import { Pencil, Trash2, UserRound, RotateCcw } from "lucide-react";
...
const PinRow = ({ pin, onEdit, onDelete, isDeletedView, onRestore, isRestoring }: PinRowProps) => {
            ...
            <div className="flex gap-2 shrink-0">
                ...
                {isDeletedView ? (
                    <button
                        ...
                        className="p-2 rounded-xl bg-green-100 dark:bg-green-500/10 text-green-600 dark:text-green-300 hover:bg-green-200 dark:hover:bg-green-500/20 transition-colors disabled:opacity-50"
                        aria-label={t('pins.restore')}
                    ...
                    <>
                        ...
                        <button
                            ...
                            className="p-2 rounded-xl bg-red-100 dark:bg-red-500/10 text-red-600 dark:text-red-300 hover:bg-red-200 dark:hover:bg-red-500/20 transition-colors"
