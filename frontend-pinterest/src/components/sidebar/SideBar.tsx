    ...
    return (
        <>
            ...
            <Modal isOpen={activeModal === 'settings'} onClose={closeModal} variant="sidebar" title={t('sidebar.settings')} width={300}>
                ...
                <button
                    onClick={() => { navigate("/settings/blocked"); closeModal(); }}
                    className="flex items-center gap-3 w-full px-3 py-3 rounded-xl hover:bg-[#a1a1a1] dark:hover:bg-[#2a2a2a] transition-colors duration-150 group"
                >
                    <div className="w-10 h-10 rounded-xl bg-[#d1d1d1] dark:bg-[#2a2a2a] dark:group-hover:bg-[#333] group-hover:bg-[#D1D1D1] flex items-center justify-center transition-colors shrink-0">
                ...
                <button
                    onClick={() => { navigate('/moodboard/archived'); closeModal(); }}
                    className="flex items-center gap-3 w-full px-3 py-3 rounded-xl hover:bg-[#a1a1a1] dark:hover:bg-[#2a2a2a] transition-colors duration-150 group"
                >
                    <div className="w-10 h-10 rounded-xl bg-[#d1d1d1] dark:bg-[#2a2a2a] dark:group-hover:bg-[#333] group-hover:bg-[#D1D1D1] flex items-center justify-center transition-colors shrink-0">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"
                    ...
                    <div className="text-left">
                        <p className="text-black dark:text-white text-sm font-medium">{t('settings.archivedBoards')}</p>
                        <p className="text-black dark:text-[#A1A1A1] text-xs">{t('settings.archivedBoardsDesc')}</p>
                    </div>
                </button>
