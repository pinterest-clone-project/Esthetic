...
public static class SharedValidationRules
{
    public static IRuleBuilderOptions<T, string> EmailRules<T>(
        ...
        rule
            ...
            .MaximumLength(255).WithMessage("Email не може бути довшим за 255 символів");
    ...
    public static IRuleBuilderOptions<T, string> PasswordRules<T>(
        ...
        rule
            ...
            .MaximumLength(100).WithMessage("Пароль не може бути довшим за 100 символів");
    ...
    public static IRuleBuilderOptions<T, string?> PhoneRules<T>(
        ...
        rule
            ...
            .MaximumLength(20).WithMessage("Номер телефону не може бути довшим за 20 символів")
    ...
    public static IRuleBuilderOptions<T, string> NameRules<T>(
        ...
        rule
            .NotEmpty().WithMessage($"{fieldName} є обов'язковим")
            .MaximumLength(50).WithMessage($"{fieldName} не може бути довшим за 50 символів");

    public static IRuleBuilderOptions<T, string?> BioRules<T>(
        this IRuleBuilder<T, string?> rule) =>
        rule
            .MaximumLength(500).WithMessage("Біографія не може бути довшою за 500 символів");
}
