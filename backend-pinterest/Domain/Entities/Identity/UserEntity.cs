...
public class UserEntity : IdentityUser<Guid>, IEntity
{
    ...
    public virtual ICollection<FollowRequestEntity>? SentFollowRequests { get; set; }
    public virtual ICollection<FollowRequestEntity>? ReceivedFollowRequests { get; set; }
}
